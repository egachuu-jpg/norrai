...
- [x] Audit workflow_events logging coverage — added Log Triggered + Log Completed Postgres nodes to all 7 real estate workflows (Instant Lead Response, Open House Setup, Listing Description, Open House Follow-Up, 7-Touch Nurture, Review Request, Lead Cleanser); transformation script at `scripts/add_workflow_logging.py`
